   ...
   <div class="card">
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input name="display_name" type="text" class="form-control"  placeholder="Display name" value="{{ $role->display_name }}">
        </div>
        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div>
                <input type="checkbox" id="permission" name="permissions[]" value="{{ $permission->id }}"  {{ $role->hasPermission($permission->name) ? 'checked' : '' }} >
